...
\textbf{\large DEPARTAMENTO DE INFORMÁTICA}\\[0.85em]
\textbf{\large SANTIAGO -- CHILE}\\[2.4em]
}
\includegraphics[scale=0.15]{images/logo-utfsm} \\[4em]
\begin{spacing}{1.8}
